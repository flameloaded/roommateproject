"""
Django settings for roommateproject project.
...
SECRET_KEY = 'django-insecure-80i!6@$1uh01)gy2a_6pnda^o+bmqx!7%u$*a&syct55a&&*3#'
...
WSGI_APPLICATION = 'roommateproject.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',   # If using mysqlclient
        'NAME': 'roommate_db',
